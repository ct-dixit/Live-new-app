    ...
    <>
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route exact path="/entertainment" element={<News key="entertainment" pageSizes={pageSize} country={country} category="entertainment" />} />
          ...
          <Route exact path="/technology" element={<News key="technology" pageSizes={pageSize} country={country} category="technology" />} />
        </Routes>
      </BrowserRouter>
    </>
  );
